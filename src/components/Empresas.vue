<template>
  <div class="mr-5 ml-5">
      ...
      <v-switch class="mr-5 ml-5" inset v-model="showCards" color="#49D9A0" :label="showCards ? 'cards' : 'table'">
      </v-switch>
               ...
               <v-simple-table dense class="elevation-1" style="max-width: 2000px;" >
                  ...
                  <tr dark style="background-color: #49D9A0;">
                     ...
                     <tbody>
                        ...
                        <td class="text-center" style="padding: 8px;"><v-btn dark  color="#49D9A0" small :to="{ name: 'perfilEmpresa', params: { id: item.id } }" class="custom-link">Ver más</v-btn></td>
                        </tr>
                     </tbody>
                  </template>
                  </v-simple-table>
